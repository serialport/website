...
- [`@serialport/bindings-cpp`](api-bindings-cpp.md) bindings for Linux, Mac and Windows
- [`@serialport/bindings-interface`](api-bindings-interface.md) as an abstract class to use if you're making your own bindings
